...
return [
    ...
    //图片的域名，必须以http://开头
    'sys_images_domain' => 'http://img.fanshub.org',

    //后台访问域名，不用http://开头
    'sys_admin_domain' => 'laravel-admin.dev',

    //博客访问域名
    'sys_blog_domain' => 'blog.laravel-admin.dev',

    //博客访问域名无前缀
    'sys_blog_nopre_domain' => 'blog.laravel-admin.dev',
